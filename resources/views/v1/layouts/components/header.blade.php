                            ...
                            <div class="profile-notification-scroll position-relative"
                                ...
                                <div class="d-flex mb-1">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <span>{{ strtoupper(str_replace('_', ' ', auth()->user()->role)) }}</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body p-3">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div>
                                                ...
                                                <h4 class="mb-0 text-white" id="balanceUser">Rp. {{ number_format(Auth::user()->balance) }}</h4>
                                            </div>
                                            <div class="avtar">
                                ...
                                <div class="card bg-gray-800 dropbox-card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h5 class="text-white">12301923812</h5>
                                            <h4 class="text-white">Mandiri</h4>
                                        </div>
                                        <div class="mb-3">
